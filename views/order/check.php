        ...
        <div class="col-xs-12 no-margin">
            <section id="shipping-address" style="margin-bottom:100px;margin-top:-10px">
                <h2 class="border h1">收货地址</h2>
                    ...
                    <div class="row field-row" style="margin-top:10px" hidden>
                        <div class="col-xs-12">
                        <input class="le-radio big address" type="radio" name="address" value=""  checked = "checked" />
            ...
            <div id="payment-method-options">
                    ...
                    <div class="payment-method-option">
                        <input class="le-radio" type="radio" name="paymethod" value="balance" checked>
                        <div class="radio-label bold ">余额支付</div>
                    </div>
