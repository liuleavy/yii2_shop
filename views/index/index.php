...
<!--						最高优惠-->
                        <span class="big"><span class="sign">
<!--                                ￥</span>400</span>-->
					</div>
...
<!--						最后 5 天限时抢购-->
					...
					<div class="button-holder fadeInDown-3">
						<a href="<?php echo yii\helpers\Url::to(['product/detail', 'productid' => 18]) ?>" class="big le-button ">去购买</a>
					</div>
				</div><!-- /.caption -->
			</div><!-- /.container-fluid -->
		</div><!-- /.item -->
...
<section id="banner-holder" class="wow fadeInUp">
    <div class="container">
        <div class="col-xs-12 col-lg-6 no-margin banner">
            <a href="<?php echo yii\helpers\Url::to(['product/index','cateid'=>'30']); ?>">
                <div class="banner-text theblue">
                    <h3 >笔记本？</h3>
                    <br>
                    <span class="tagline"><h1>也能吃鸡！</h1></span>
                </div>
                <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/chiji.jpg" />
            </a>
        </div>
        <div class="col-xs-12 col-lg-6 no-margin text-right banner">
            <a href="<?php echo yii\helpers\Url::to(['product/index','cateid'=>'19']) ?>">
                <div class="banner-text right">
                    <h1 style="font-family:'Microsoft Yahei';">来</h1>
                    <span class="tagline">开黑啊！</span>
                </div>
                <img class="banner-image" alt="" src="assets/images/blank.gif" data-echo="assets/images/banners/wangzherongyao.jpg" />
            </a>
        </div>
    </div><!-- /.container -->
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="featured">
                    ...
                    <div class="loadmore-holder text-center">
                        <a class="btn-loadmore" href="<?php echo yii\helpers\Url::to(['product/moretui','istui'=>1]) ?>">
                ...
                <div class="tab-pane" id="new-arrivals">
                    ...
                    <div class="loadmore-holder text-center">
                        <a class="btn-loadmore" href="<?php echo yii\helpers\Url::to(['product/morenew',]) ?>">
                            <i class="fa fa-plus"></i>
                            查看更多</a>
                    </div> 
                ...
                <div class="tab-pane" id="top-sales">
                    ...
                    <div class="loadmore-holder text-center">
                        <a class="btn-loadmore" href="<?php echo yii\helpers\Url::to(['product/morehot','ishot'=>1]) ?>">
                            <i class="fa fa-plus"></i>
                            查看更多</a>
                    </div> 
                </div>
            ...
            <div class="col-xs-12 col-md-7 no-margin">
                ...
                <div class="row no-margin">
                    ...
                    <div class="col-xs-12 col-sm-4 no-margin product-item-holder size-medium hover">
                        <div class="product-item">
                            <div class="image">
                            <img alt="<?php echo $data['all'][$i]->title ?>" src="<?php echo "http://".$data['all'][$i]->cover ?>-covermiddle" data-echo="<?php echo "http://".$data['all'][$i]->cover ?>-covermiddle" />
                            </div>
                            <div class="body">
            ...
            <div class="col-xs-12 col-md-5 no-margin">
                <div class="product-item-holder size-big single-product-gallery small-gallery">
                    ...
                    <div id="best-seller-single-product-slider" class="single-product-slider owl-carousel">
                        ...
                        <a data-rel="prettyphoto" href="<?php echo "http://".$last['cover'] ?>->coverbig">
                        <img alt="<?php echo $last->title ?>" src="<?php echo "http://".$last->cover ?>-coverbig"
                             data-echo="<?php echo "http://".$last->cover ?>-coverbig" />
                            </a>
                        </div><!-- /.single-product-gallery-item -->
                        <?php $i = 2 ?>
                        <?php foreach((array)json_decode($last['pics'], true) as $k => $pic): ?>
                        <div class="single-product-gallery-item" id="slide<?php echo $i; ?>">
                            <a data-rel="prettyphoto" href="<?php echo "http://".$pic ?>->coverbig">
                                <img alt="" src="<?php echo "http://".$pic ?>-coverbig" data-echo="<?php echo "http://".$pic ?>-coverbig" />
                            </a>
                        </div><!-- /.single-product-gallery-item -->
                        <?php endforeach; ?>
                    ...
                    <div class="gallery-thumbs clearfix">
                        <ul>
                        <li><a class="horizontal-thumb active" data-target="#best-seller-single-product-slider" data-slide="0" href="#slide1"><img alt="<?php echo $last->title ?>" src="<?php echo "http://".$last->cover ?>-picsmall" data-echo="<?php echo "http://".$last->cover ?>-picsmall" /></a></li>
                        <?php foreach ((array)json_decode($last->pics, true) as $key => $pic): ?>
                            <li><a class="horizontal-thumb" data-target="#best-seller-single-product-slider" data-slide="<?php echo $key+1; ?>" href="#slide<?php echo $key+2; ?>"><img alt="" src="<?php echo "http://".$pic ?>-picsmall" data-echo="<?php echo "http://".$pic ?>-picsmall" /></a></li>
                        <?php endforeach; ?>
                        </ul>
                    </div><!-- /.gallery-thumbs -->
