...
<html lang="zh-cn">
	<head>
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="assets/images/header_u.png">
...
<!-- ============================================================= LOGO : END ============================================================= -->		</div><!-- /.logo-holder -->
    ...
    <div class="phone inline">
        <i class="fa fa-phone"></i> 132 6169 1995
    </div>
    <div class="contact inline">
        <i class="fa fa-envelope"></i> llw1021@<span class="le-color">126.com</span>
    </div>
</div><!-- /.contact-row -->
<!-- ============================================================= SEARCH AREA ============================================================= -->
...
<div class="contact-info">
            ...
            <div class="col-xs-12 col-md-8 no-margin">
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>购物指南</h3>
                        <ul>
                            <li><a href="<?php echo yii\helpers\Url::to(['member/auth']) ?>">免费注册</a></li>
                        </ul>
                    </div><!-- /.widget -->
                </div><!-- /.link-widget -->
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>品质保障</h3>
                        <ul>
                            <li><a href="<?php echo yii\helpers\Url::to(); ?>">品质保证</a></li>
                        </ul>
                    </div><!-- /.widget -->
                </div><!-- /.link-widget -->
                ...
                <div class="link-widget">
                    <div class="widget">
                        <h3>服务体验</h3>
                        <ul>
                            <li><a href="<?php echo yii\helpers\Url::to() ?>">服务体验</a></li>
                        </ul>
                    </div><!-- /.widget -->
                </div><!-- /.link-widget -->
    ...
    <div class="copyright-bar">
        <div class="container">
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="copyright">
                    &copy; <a href="<?php echo yii\helpers\Url::to(['index/index']) ?>">优选仓</a> - all rights reserved
                </div><!-- /.copyright -->
            </div>
            <div class="col-xs-12 col-sm-6 no-margin">
