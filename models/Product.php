...
{
    const AK = 'xBtKvuHBtHrjGKXBOG6R5q62iRvTRItoBj3b6kQD';
    const SK = 'svPBJ2UL6Pk5315GfwTlQkwGrkCsTJtDiGpLXPqF';
    const DOMAIN = 'p4i9vejkv.bkt.clouddn.com';
    const BUCKET = 'liuliwei';
